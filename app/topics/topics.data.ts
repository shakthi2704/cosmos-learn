...
export const allTopics: Topic[] = [
  {
    ...
    longDescription:
      "Explore the eight planets, dwarf planets, moons, asteroids, and comets that make up our solar system.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "Explore the most extreme objects in the universe where the laws of physics break down and nothing can escape.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "Discover the invisible substance that makes up 85% of the universe's mass but has never been directly observed.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "Journey back to the explosive birth of space, time, and matter 13.8 billion years ago.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "Explore the vast collections of billions of stars, gas, and dark matter that form the building blocks of the universe.",
    image:
  ...
  },
  {
    ...
    longDescription:
      "Discover the thousands of worlds orbiting distant stars and the search for life beyond Earth.",
    image:
      "https://images.unsplash.com/photo-1614313913007-2b4ae8ce32d6?w=600&q=80",
    category: "Planetary Science",
    domains: ["astronomy"],
    difficulty: "Intermediate",
    readTime: "6 min read",
  ...
  },
  {
    ...
    longDescription:
      "Witness the spectacular birthplaces of stars in colorful clouds of gas and dust.",
    image:
